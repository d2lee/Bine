    ...
    operations = [
            ...
            fields=[
                ...
                ('user_permissions',
                 models.ManyToManyField(to='auth.Permission', verbose_name='user permissions', blank=True,
                                        help_text='Specific permissions for this user.', related_query_name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language',
                 models.CharField(max_length=2, choices=[('ko', '한국어'), ('en', '영어'), ('jp', '일어'), ('cn', '중국')],
                                  default='ko')),
                ('age_level', models.CharField(max_length=1,
                                               choices=[('1', '0-3세'), ('2', '4-7세'), ('3', '초등1-2'), ('4', '초등3-4'),
                                                        ('5', '초등5-6'), ('6', '청소년'), ('7', '성인'), ('8', '유아전체'),
                                                        ('9', '초등전체')], default='9')),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share_to',
                 models.CharField(max_length=1, choices=[('P', '개인'), ('F', '친구'), ('A', '모두')], default='2')),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
