...
from bine.views import BookList, BookNoteList, BookNoteDetail, \
    ...
    Login, Register, IndexView, FriendList
...
urlpatterns = [
    ...
    url(r'^friend/$', FriendList.as_view()),
    url(r'^friend/(?P<pk>[0-9]+)/$', FriendList.as_view()),
    url(r'^friend/(?P<action>[a-zA-Z]+)/$', FriendList.as_view()),
